  ...
  Widget build(BuildContext context) {
    return WillPopScope(
        onWillPop: () async {
          ...
          // Navigate to PodScreen when the back button is pressed
